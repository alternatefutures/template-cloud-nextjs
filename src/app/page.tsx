  ...
  return (
    <main className="w-3/4 flex flex-col items-center gap-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 absolute">
      ...
      <p className="text-2xl">
        This is a template for creating a Next.js site and deploying it on Alternate Futures.
      </p>
      ...
      >
        <Card
          ...
          title="Alternate Futures Documentation"
        ...
        <Card
          ...
          body="Checkout our Blog for more information about Alternate Futures."
        />
        <Card
          icon='/nextMark.svg'
          width={31}
